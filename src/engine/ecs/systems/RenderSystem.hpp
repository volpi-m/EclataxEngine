    ...
    namespace System {
        ...
        class RenderSystem : public ISystem {
            public:
                ...
                std::string texture(const std::shared_ptr<ECS::Entity> &entity) const;
                ...
                void setTexture(const std::shared_ptr<ECS::Entity> &entity, const std::string &texture);

                /// \brief the sprite is loaded by the client. (the client tries to load the sprite until the atttribute is set to true)
                /// \param entity : texture file to add to the sprite
                void setLoaded(const std::shared_ptr<ECS::Entity> &entity);
