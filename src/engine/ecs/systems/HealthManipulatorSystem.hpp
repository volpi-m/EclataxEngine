    ...
    namespace System {
        ...
        class HealthManipulator : public ISystem {
            public:
                ...
                void subHealth(std::shared_ptr<Entity> &entity, std::size_t health);

                /// \param entity : the target entity
                /// \brief add life to an entity
                void addHealth(std::shared_ptr<Entity> &entity, std::size_t health);

                /// \param entity : the target entity
                /// \brief set life of an entity
                void setHealth(std::shared_ptr<Entity> &entity, std::size_t health);

                /// \param entity : the target entity
                /// \brief set life limit of an entity
                void setHealthLimit(std::shared_ptr<Entity> &entity, std::size_t health);

                /// \return the health of the current entity
                /// \param entity : the target entity
                /// \brief get the healh of the tageted entity
                std::size_t health(std::shared_ptr<Entity> &entity) const;

                /// \return the health limit of the current entity
                /// \param entity : the target entity
                /// \brief get the healh limit of the tageted entity
                std::size_t healthLimit(std::shared_ptr<Entity> &entity) const;
        };
    }
}