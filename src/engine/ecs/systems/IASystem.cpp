...
void ECS::System::IASystem::setScript(const std::shared_ptr<Entity> &entity, void (*func)(const std::shared_ptr<ECS::Entity> &entity))
{
    // Casting the script component
...
void ECS::System::IASystem::deleteScript(const std::shared_ptr<Entity> &entity)
{
    // Casting the script component
    auto component = static_cast<ECS::Component::Script *>(entity->component(Component::Flags::script).get());
